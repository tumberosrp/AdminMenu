--	JUST DON'T EDIT			JUST DON'T EDIT			JUST DON'T EDIT			JUST DON'T EDIT
--	JUST DON'T EDIT			JUST DON'T EDIT			JUST DON'T EDIT			JUST DON'T EDIT
--	JUST DON'T EDIT			JUST DON'T EDIT			JUST DON'T EDIT			JUST DON'T EDIT
--	JUST DON'T EDIT			JUST DON'T EDIT			JUST DON'T EDIT			JUST DON'T EDIT
--	JUST DON'T EDIT			JUST DON'T EDIT			JUST DON'T EDIT			JUST DON'T EDIT
...
--Functions
	...
	function DrawPlayerList()--Scoreboard Function (Thanks To ash [forum.FiveM.net])
		local players = {}
		...
		for k, v in pairs( players ) do
			...
			--Wanted Stars
			if SettingsScoreboard["WantedStars"] then
...
--Event Registering
	RegisterNetEvent("FMODT:Title")
	RegisterNetEvent("FMODT:Option")
	RegisterNetEvent("FMODT:Bool")
	RegisterNetEvent("FMODT:Int")
